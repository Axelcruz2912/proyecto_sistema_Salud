<x-layouts.app title="Dashboard Usuario">

    <div class="min-h-screen bg-slate-900 text-white p-10 flex flex-col gap-6">

        <div>
            <h1 class="text-3xl font-bold mb-2">Panel Usuario</h1>
